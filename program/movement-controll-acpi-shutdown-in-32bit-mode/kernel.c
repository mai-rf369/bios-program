...
const unsigned char font8x8[95][8] = {
	...
	{0x38,0x6C,0x68,0x70,0x6C,0x66,0x3B,0x00}, {0x18,0x18,0x30,0x00,0x00,0x00,0x00,0x00},
...
void main(void)
{
	...
	while (1)
	{
		...
		draw_string(4, 14, "Arrows: Move", 15, vram);
